...
clang++ -std=c++17 -stdlib=libc++ main.cpp other.cpp -IFrameworks/SDL2.framework/Headers -IFrameworks/SDL2_image.framework/Headers -rpath ./ -F ./ -framework SDL2 -framework SDL2_image -o app
